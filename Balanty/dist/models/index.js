...
exports.userMessage = exports.User = exports.Gallery = exports.Message = exports.Match = exports.Review = exports.Stadium = exports.Player = void 0;
...
// مرسل الرسالة
userMessage_1.default.belongsTo(User_1.default, { as: 'From', foreignKey: 'FromID' });
User_1.default.hasMany(userMessage_1.default, { as: 'SentMessages', foreignKey: 'FromID' });
// مستقبل الرسالة
userMessage_1.default.belongsTo(User_1.default, { as: 'To', foreignKey: 'ToID' });
User_1.default.hasMany(userMessage_1.default, { as: 'ReceivedMessages', foreignKey: 'ToID' });
// Match with Message
...
//gallery
User_1.default.hasMany(Gallery_1.default, {
    as: 'UserGallery',
});
Gallery_1.default.belongsTo(User_1.default);
