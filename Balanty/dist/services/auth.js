...
const signupService = async (userData) => {
    ...
    if (userExists?.username === username) {
        throw new utils_1.CustomError(409, 'اسم المستخدم موجود');
    }
    if (userExists?.email === email) {
        throw new utils_1.CustomError(409, 'هذا الايميل مستخدم');
    }
    if ((userExists?.phone ?? 0) === phone) {
        throw new utils_1.CustomError(409, 'هذا الهاتف مستخدم');
    }
