...
exports.getPlayerInfo = exports.updateAvatar = exports.updateCover = exports.playerAvatar = exports.getPlayers = exports.playerMatches = exports.updatePlayer = exports.getPlayer = void 0;
...
const getPlayerInfo = async (req, res) => {
    const { id } = req.params;
    const response = await (0, player_1.getPlayerInfoService)(+id, req);
    res.status(response.status).json(response);
};
